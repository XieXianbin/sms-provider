...
//	signature := aliyun.signature_method(`testsecret`, string_to_sign)
...
func Test_string_to_sign(t *testing.T) {
	...
	c.Param.SetSignName("谢先斌")
	c.Param.SetTemplateCode("SMS_48825019")
	c.Param.SetRecNum("13523591108")
	c.Param.SetParamString(`{"context":"sms_content","sms_content":"test"}`)
	c.Param.SetFormat("XML")
	c.Param.SetVersion("2016-09-27")
	c.Param.SetAccessKeyId("testid")
	c.Param.SetSignatureMethod("HMAC-SHA1")
	c.Param.SetTimestamp("2017-02-2515:20:43Z")
	c.Param.SetSignatureVersion("1.0")
	c.Param.SetSignatureNonce("ae476f95-2da9-4dfd-b229-8e77baa5a7ba")
	c.Param.SetRegionId("cn-hangzhou")
	log.Println(c)
//	string_to_sign := c.calc_string_to_sign()
	//	signature_method(c.AccessKey, c.calc_string_to_sign())
	//	log.Println(string_to_sign)
